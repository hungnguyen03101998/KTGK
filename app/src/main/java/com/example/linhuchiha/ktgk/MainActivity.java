...
public class MainActivity extends AppCompatActivity {
    ...
    myarrayAdapter myarray1, myarrray2, myarray3;
    @Override
    ...
    private void addControl() {
        ...
        myarray1 = new myarrayAdapter(MainActivity.this,R.layout.layout2,list1);
        myarrray2 = new myarrayAdapter(MainActivity.this,R.layout.layout2,list2);
        myarray3 = new myarrayAdapter(MainActivity.this,R.layout.layout2,list3);
        lv1.setAdapter(myarray1);
        lv2.setAdapter(myarrray2);
